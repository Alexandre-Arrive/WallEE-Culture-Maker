...
{
   Serial.println("");
   Serial.print("Capteur front : ");Serial.println(Ultrason_Read(front));
   delay(1000);
   Serial.print("Capteur right : ");Serial.println(Ultrason_Read(right));
   delay(1000);
   Serial.print("Capteur left : ");Serial.println(Ultrason_Read(left));
   delay(1000);
   Serial.print("Capteur back : ");Serial.println(Ultrason_Read(back));
   delay(1000);
   delay(2000);
   
   Serial.print("Nombre d'erreurs :");Serial.println(erreur_ultrason);
   Serial.println("");Serial.println("");
   Serial.print("Essai du code d'erreur : ");ultrason_ERREUR();
   
   Serial.print("Detection front : ");Serial.println(Ultrason_Indication(front));
   delay(1000);
   Serial.print("Detection right : ");Serial.println(Ultrason_Indication(right));
   delay(1000);
   Serial.print("Detection left : ");Serial.println(Ultrason_Indication(left));
   delay(1000);
   Serial.print("Detection back : ");Serial.println(Ultrason_Indication(back));
   delay(1000);
   delay(2000);
   Serial.println("");Serial.println("");
   ...
   for (int i=0; i<=3; i++){
      Serial.print("Capteur numéro : "); Serial.print(i); Serial.print(" a détecté: ");Serial.println(distance[i]);
   }
   delete distance;
   delay(2500);
   Serial.println("");Serial.println("");
   ...
   for (int i=0; i<=3; i++){
      Serial.print("Capteur numéro : "); Serial.print(i); Serial.print(" a détecté: ");Serial.println(indication[i]);
   }
   delete indication;
   delay(2500);
   Serial.println("");Serial.println("");
